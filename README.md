...
1. 打开你的 GitHub 仓库页面：[https://github.com/icoolmedia/icoolmedia.github.io](https://github.com/icoolmedia/icoolmedia.github.io)
2. 点击顶部的 **"Actions"** 标签。
3. 你会看到名为 **"Build and Deploy"** 的工作流正在运行（黄色圆圈表示进行中，绿色对勾表示成功）。
4. 部署通常需要 1-2 分钟。
